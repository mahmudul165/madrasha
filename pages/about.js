    ...
    <div className="min-h-screen bg-gradient-to-tr from-green-50 to-white text-gray-800 px-4 md:px-10 py-8">
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="text-4xl md:text-5xl font-extrabold text-center text-green-800 drop-shadow-lg"
        >
          তাকওয়া-নূরানী ও হাফেজিয়া মাদরাসা
        </motion.h1>
